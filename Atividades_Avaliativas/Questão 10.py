...
# Questão 10: Um posto está vendendo combustíveis com a seguinte tabela de descontos: 
# Escreva um algoritmo que leia o número de litros vendidos e o tipo de combustível 
# (codificado da seguinte forma: A-álcool,G-gasolina), calcule e imprima o valor a ser pago pelo 
# cliente sabendo-se que o preço do litro da gasolina é R$ 6,59 e o preço do 
# litro do álcool é R$ 3,79.
